...
require (
	...
	github.com/jsipprell/keyctl v1.0.4-0.20211208153515-36ca02672b6c // indirect
	...
	github.com/opensaucerer/grab/v3 v3.0.1 // indirect
	github.com/opensciencegrid/xrootd-monitoring-shoveler v1.3.0 // indirect
